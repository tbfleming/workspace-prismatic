...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | org-jscut-workspace-prismatic |
| Name                  | Workspace / Sample |
| Description           | A ChiliPeppr Workspace sample. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/tbfleming/workspace-prismatic/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/undefined/undefined |
| Github URL            | http://github.com/tbfleming/workspace-prismatic |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/tbfleming/workspace-prismatic/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:org-jscut-workspace-prismatic"], // the id you gave your workspace
      function(myOrgJscutWorkspacePrismatic) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Sample just got loaded.", myOrgJscutWorkspacePrismatic);
        myOrgJscutWorkspacePrismatic.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"org-jscut-workspace-prismatic"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Sample"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace sample."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/tbfleming/workspace-prismatic/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/undefined/undefined"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/tbfleming/workspace-prismatic"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://undefined-undefined.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
follows the standard template for workspace pulldown menus.</td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () <br><br>Listen to window resize event.</td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () <br><br>When browser window resizes, forcibly resize the Console window</td></tr><tr valign="top"><td>loadLocal</td><td>function</td><td>function (id, url, callback) </td></tr><tr valign="top"><td>load</td><td>function</td><td>function (id, url, localUrl, callback) </td></tr><tr valign="top"><td>loadMeshWidget</td><td>function</td><td>function () </td></tr><tr valign="top"><td>loadPrismaticWidget</td><td>function</td><td>function () </td></tr><tr valign="top"><td>loadCam2DWidget</td><td>function</td><td>function () </td></tr><tr valign="top"><td>load3dWidget</td><td>function</td><td>function (callback) </td></tr><tr valign="top"><td>loadDragDropWidget</td><td>function</td><td>function () </td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
